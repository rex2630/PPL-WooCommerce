...
class ShipmentLabelRefreshBatchModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\ShipmentLabelRefreshBatchModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\ShipmentLabelRefreshBatchModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\ShipmentLabelRefreshBatchModel();
    ...
    {
        return array('PPLCZ\\Model\\Model\\ShipmentLabelRefreshBatchModel' => false);
    }
}