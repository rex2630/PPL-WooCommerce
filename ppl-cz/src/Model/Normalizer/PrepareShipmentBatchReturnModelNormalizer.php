...
class PrepareShipmentBatchReturnModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\PrepareShipmentBatchReturnModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\PrepareShipmentBatchReturnModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\PrepareShipmentBatchReturnModel();
    ...
    {
        return array('PPLCZ\\Model\\Model\\PrepareShipmentBatchReturnModel' => false);
    }
}