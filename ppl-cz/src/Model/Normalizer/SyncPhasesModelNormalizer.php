...
class SyncPhasesModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\SyncPhasesModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\SyncPhasesModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\SyncPhasesModel();
        ...
        if (\array_key_exists('phases', $data) && $data['phases'] !== null) {
            ...
            foreach ($data['phases'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'PPLCZ\\Model\\Model\\ShipmentPhaseModel', 'json', $context);
            }
    ...
    {
        return array('PPLCZ\\Model\\Model\\SyncPhasesModel' => false);
    }
}