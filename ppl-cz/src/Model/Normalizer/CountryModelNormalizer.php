...
class CountryModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\CountryModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\CountryModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\CountryModel();
        ...
        if (\array_key_exists('parcelAllowed', $data)) {
            $object->setParcelAllowed($data['parcelAllowed']);
            unset($data['parcelAllowed']);
        }
        if (\array_key_exists('codAllowed', $data)) {
            $values = array();
            foreach ($data['codAllowed'] as $value) {
                $values[] = $value;
            }
            $object->setCodAllowed($values);
            unset($data['codAllowed']);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        $data['parcelAllowed'] = $object->getParcelAllowed();
        $values = array();
        foreach ($object->getCodAllowed() as $value) {
            $values[] = $value;
        }
        $data['codAllowed'] = $values;
    ...
    {
        return array('PPLCZ\\Model\\Model\\CountryModel' => false);
    }
}