...
use PPLCZVendor\Symfony\Component\Validator\Constraints\GreaterThanOrEqual;
class MinimumValidator implements ValidatorInterface
{
    ...
    {
        $guess->addValidatorGuess(new ValidatorGuess(GreaterThanOrEqual::class, ['value' => $object->getMinimum()]));
    }
}
