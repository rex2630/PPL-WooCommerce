...
use PPLCZVendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use PPLCZVendor\Http\Discovery\Exception\DiscoveryFailedException;
use PPLCZVendor\Http\Discovery\Exception\NoCandidateFoundException;
use PPLCZVendor\Http\Discovery\Exception\StrategyUnavailableException;
use PPLCZVendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
