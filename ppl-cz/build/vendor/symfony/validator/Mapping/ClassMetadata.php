 ...
 */
namespace PPLCZVendor\Symfony\Component\Validator\Mapping;

use PPLCZVendor\Symfony\Component\Validator\Constraint;
use PPLCZVendor\Symfony\Component\Validator\Constraints\Cascade;
...
use PPLCZVendor\Symfony\Component\Validator\Constraints\Traverse;
...
use PPLCZVendor\Symfony\Component\Validator\Exception\GroupDefinitionException;
/**
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
    ...
    public function setGroupSequenceProvider(bool $active)
    {
        ...
        if (!$this->getReflectionClass()->implementsInterface('PPLCZVendor\\Symfony\\Component\\Validator\\GroupSequenceProviderInterface')) {
