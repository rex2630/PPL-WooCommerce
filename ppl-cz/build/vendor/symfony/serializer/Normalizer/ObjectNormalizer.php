...
use PPLCZVendor\Symfony\Component\PropertyAccess\PropertyAccess;
use PPLCZVendor\Symfony\Component\PropertyAccess\PropertyAccessorInterface;
use PPLCZVendor\Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor;
use PPLCZVendor\Symfony\Component\PropertyInfo\PropertyInfoExtractorInterface;
use PPLCZVendor\Symfony\Component\PropertyInfo\PropertyTypeExtractorInterface;
use PPLCZVendor\Symfony\Component\PropertyInfo\PropertyWriteInfo;
use PPLCZVendor\Symfony\Component\Serializer\Annotation\Ignore;
use PPLCZVendor\Symfony\Component\Serializer\Exception\LogicException;
use PPLCZVendor\Symfony\Component\Serializer\Mapping\AttributeMetadata;
...
class ObjectNormalizer extends AbstractObjectNormalizer
{
    ...
    protected function getAttributeValue(object $object, string $attribute, ?string $format = null, array $context = [])
    {
        ...
        return $attribute === $discriminatorProperty ? $this->classDiscriminatorResolver->getTypeForMappedObject($object) : $this->propertyAccessor->getValue($object, $attribute);
    }
    /**
     * {@inheritdoc}
     */
    ...
    private function hasAttributeAccessorMethod(string $class, string $attribute) : bool
    {
        ...
        return !$method->isStatic() && (\PHP_VERSION_ID < 80000 || !$method->getAttributes(Ignore::class)) && !$method->getNumberOfRequiredParameters();
    }
}
