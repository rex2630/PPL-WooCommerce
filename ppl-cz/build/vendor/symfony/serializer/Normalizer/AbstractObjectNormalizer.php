...
use PPLCZVendor\Symfony\Component\PropertyAccess\Exception\InvalidArgumentException as PropertyAccessInvalidArgumentException;
use PPLCZVendor\Symfony\Component\PropertyAccess\Exception\NoSuchPropertyException;
use PPLCZVendor\Symfony\Component\PropertyAccess\Exception\UninitializedPropertyException;
use PPLCZVendor\Symfony\Component\PropertyInfo\PropertyTypeExtractorInterface;
use PPLCZVendor\Symfony\Component\PropertyInfo\Type;
use PPLCZVendor\Symfony\Component\Serializer\Encoder\CsvEncoder;
use PPLCZVendor\Symfony\Component\Serializer\Encoder\JsonEncoder;
use PPLCZVendor\Symfony\Component\Serializer\Encoder\XmlEncoder;
use PPLCZVendor\Symfony\Component\Serializer\Exception\ExtraAttributesException;
...
use PPLCZVendor\Symfony\Component\Serializer\Exception\MissingConstructorArgumentsException;
use PPLCZVendor\Symfony\Component\Serializer\Exception\NotNormalizableValueException;
use PPLCZVendor\Symfony\Component\Serializer\Mapping\AttributeMetadataInterface;
use PPLCZVendor\Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata;
use PPLCZVendor\Symfony\Component\Serializer\Mapping\ClassDiscriminatorResolverInterface;
use PPLCZVendor\Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactoryInterface;
use PPLCZVendor\Symfony\Component\Serializer\NameConverter\NameConverterInterface;
/**
...
abstract class AbstractObjectNormalizer extends AbstractNormalizer
{
    ...
    public function normalize($object, ?string $format = null, array $context = [])
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            try {
                $attributeValue = $attribute === $discriminatorProperty ? $this->classDiscriminatorResolver->getTypeForMappedObject($object) : $this->getAttributeValue($object, $attribute, $format, $attributeContext);
    ...
    public function denormalize($data, string $type, ?string $format = null, array $context = [])
    {
        ...
        foreach ($normalizedData as $attribute => $value) {
            ...
            if ($attributeContext[self::DEEP_OBJECT_TO_POPULATE] ?? $this->defaultContext[self::DEEP_OBJECT_TO_POPULATE] ?? \false) {
                ...
                try {
                    $attributeContext[self::OBJECT_TO_POPULATE] = $attribute === $discriminatorProperty ? $this->classDiscriminatorResolver->getTypeForMappedObject($object) : $this->getAttributeValue($object, $attribute, $format, $attributeContext);
