...
namespace PPLCZVendor\PhpParser\Lexer;

use PPLCZVendor\PhpParser\Error;
use PPLCZVendor\PhpParser\ErrorHandler;
use PPLCZVendor\PhpParser\Lexer;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use PPLCZVendor\PhpParser\Lexer\TokenEmulator\TokenEmulator;
