 ...
 */
\class_alias("Couchbase\\Cluster", "PPLCZVendor\\CouchbaseCluster");
\class_alias("Couchbase\\Bucket", "PPLCZVendor\\CouchbaseBucket");
\class_alias("Couchbase\\MutationToken", "PPLCZVendor\\CouchbaseMutationToken");
\class_alias("Couchbase\\MutationState", "PPLCZVendor\\CouchbaseMutationState");
\class_alias("Couchbase\\BucketManager", "PPLCZVendor\\CouchbaseBucketManager");
\class_alias("PPLCZVendor\\Couchbase\\ClusterManager", "PPLCZVendor\\CouchbaseClusterManager");
\class_alias("PPLCZVendor\\Couchbase\\LookupInBuilder", "PPLCZVendor\\CouchbaseLookupInBuilder");
\class_alias("PPLCZVendor\\Couchbase\\MutateInBuilder", "PPLCZVendor\\CouchbaseMutateInBuilder");
\class_alias("PPLCZVendor\\Couchbase\\N1qlQuery", "PPLCZVendor\\CouchbaseN1qlQuery");
\class_alias("Couchbase\\SearchQuery", "PPLCZVendor\\CouchbaseSearchQuery");
\class_alias("PPLCZVendor\\Couchbase\\SearchQueryPart", "PPLCZVendor\\CouchbaseAbstractSearchQuery");
\class_alias("Couchbase\\QueryStringSearchQuery", "PPLCZVendor\\CouchbaseStringSearchQuery");
\class_alias("Couchbase\\MatchSearchQuery", "PPLCZVendor\\CouchbaseMatchSearchQuery");
\class_alias("Couchbase\\MatchPhraseSearchQuery", "PPLCZVendor\\CouchbaseMatchPhraseSearchQuery");
\class_alias("Couchbase\\PrefixSearchQuery", "PPLCZVendor\\CouchbasePrefixSearchQuery");
\class_alias("Couchbase\\RegexpSearchQuery", "PPLCZVendor\\CouchbaseRegexpSearchQuery");
\class_alias("Couchbase\\NumericRangeSearchQuery", "PPLCZVendor\\CouchbaseNumericRangeSearchQuery");
\class_alias("Couchbase\\DisjunctionSearchQuery", "PPLCZVendor\\CouchbaseDisjunctionSearchQuery");
\class_alias("Couchbase\\DateRangeSearchQuery", "PPLCZVendor\\CouchbaseDateRangeSearchQuery");
\class_alias("Couchbase\\ConjunctionSearchQuery", "PPLCZVendor\\CouchbaseConjunctionSearchQuery");
\class_alias("Couchbase\\BooleanSearchQuery", "PPLCZVendor\\CouchbaseBooleanSearchQuery");
\class_alias("Couchbase\\WildcardSearchQuery", "PPLCZVendor\\CouchbaseWildcardSearchQuery");
\class_alias("Couchbase\\DocIdSearchQuery", "PPLCZVendor\\CouchbaseDocIdSearchQuery");
\class_alias("Couchbase\\BooleanFieldSearchQuery", "PPLCZVendor\\CouchbaseBooleanFieldSearchQuery");
\class_alias("Couchbase\\TermSearchQuery", "PPLCZVendor\\CouchbaseTermSearchQuery");
\class_alias("Couchbase\\PhraseSearchQuery", "PPLCZVendor\\CouchbasePhraseSearchQuery");
\class_alias("Couchbase\\MatchAllSearchQuery", "PPLCZVendor\\CouchbaseMatchAllSearchQuery");
\class_alias("Couchbase\\MatchNoneSearchQuery", "PPLCZVendor\\CouchbaseMatchNoneSearchQuery");
\class_alias("Couchbase\\DateRangeSearchFacet", "PPLCZVendor\\CouchbaseDateRangeSearchFacet");
\class_alias("Couchbase\\NumericRangeSearchFacet", "PPLCZVendor\\CouchbaseNumericRangeSearchFacet");
\class_alias("Couchbase\\TermSearchFacet", "PPLCZVendor\\CouchbaseTermSearchFacet");
\class_alias("Couchbase\\SearchFacet", "PPLCZVendor\\CouchbaseSearchFacet");
\class_alias("PPLCZVendor\\Couchbase\\ViewQuery", "PPLCZVendor\\CouchbaseViewQuery");
\class_alias("PPLCZVendor\\Couchbase\\DocumentFragment", "PPLCZVendor\\CouchbaseDocumentFragment");
\class_alias("PPLCZVendor\\Couchbase\\Document", "PPLCZVendor\\CouchbaseMetaDoc");
\class_alias("PPLCZVendor\\Couchbase\\Exception", "PPLCZVendor\\CouchbaseException");
\class_alias("PPLCZVendor\\Couchbase\\ClassicAuthenticator", "PPLCZVendor\\CouchbaseAuthenticator");
