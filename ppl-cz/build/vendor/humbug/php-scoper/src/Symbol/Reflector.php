...
use PPLCZVendor\JetBrains\PHPStormStub\PhpStormStubsMap;
...
final class Reflector
{
    private const MISSING_CLASSES = [
        ...
        'PPLCZVendor\\Swoole\\Atomic',
        'PPLCZVendor\\Swoole\\Atomic\\Long',
        'PPLCZVendor\\Swoole\\Client',
        'PPLCZVendor\\Swoole\\Client\\Exception',
        'PPLCZVendor\\Swoole\\Connection\\Iterator',
        'PPLCZVendor\\Swoole\\Coroutine',
        'PPLCZVendor\\Swoole\\Coroutine\\Channel',
        'PPLCZVendor\\Swoole\\Coroutine\\Client',
        'PPLCZVendor\\Swoole\\Coroutine\\Context',
        'PPLCZVendor\\Swoole\\Coroutine\\Curl\\Exception',
        'PPLCZVendor\\Swoole\\Coroutine\\Http2\\Client',
        'PPLCZVendor\\Swoole\\Coroutine\\Http2\\Client\\Exception',
        'PPLCZVendor\\Swoole\\Coroutine\\Http\\Client',
        'PPLCZVendor\\Swoole\\Coroutine\\Http\\Client\\Exception',
        'PPLCZVendor\\Swoole\\Coroutine\\Http\\Server',
        'PPLCZVendor\\Swoole\\Coroutine\\Iterator',
        'PPLCZVendor\\Swoole\\Coroutine\\MySQL',
        'PPLCZVendor\\Swoole\\Coroutine\\MySQL\\Exception',
        'PPLCZVendor\\Swoole\\Coroutine\\MySQL\\Statement',
        'PPLCZVendor\\Swoole\\Coroutine\\Redis',
        'PPLCZVendor\\Swoole\\Coroutine\\Scheduler',
        'PPLCZVendor\\Swoole\\Coroutine\\Socket',
        'PPLCZVendor\\Swoole\\Coroutine\\Socket\\Exception',
        'PPLCZVendor\\Swoole\\Coroutine\\System',
        'PPLCZVendor\\Swoole\\Error',
        'PPLCZVendor\\Swoole\\Event',
        'PPLCZVendor\\Swoole\\Exception',
        'PPLCZVendor\\Swoole\\ExitException',
        'PPLCZVendor\\Swoole\\Http2\\Request',
        'PPLCZVendor\\Swoole\\Http2\\Response',
        'PPLCZVendor\\Swoole\\Http\\Request',
        'PPLCZVendor\\Swoole\\Http\\Response',
        'PPLCZVendor\\Swoole\\Http\\Server',
        'PPLCZVendor\\Swoole\\Lock',
        'PPLCZVendor\\Swoole\\Process',
        'PPLCZVendor\\Swoole\\Process\\Pool',
        'PPLCZVendor\\Swoole\\Redis\\Server',
        'PPLCZVendor\\Swoole\\Runtime',
        'PPLCZVendor\\Swoole\\Server',
        'PPLCZVendor\\Swoole\\Server\\Event',
        'PPLCZVendor\\Swoole\\Server\\Packet',
        'PPLCZVendor\\Swoole\\Server\\PipeMessage',
        'PPLCZVendor\\Swoole\\Server\\Port',
        'PPLCZVendor\\Swoole\\Server\\StatusInfo',
        'PPLCZVendor\\Swoole\\Server\\Task',
        'PPLCZVendor\\Swoole\\Server\\TaskResult',
        'PPLCZVendor\\Swoole\\Table',
        'PPLCZVendor\\Swoole\\Timer',
        'PPLCZVendor\\Swoole\\Timer\\Iterator',
        'PPLCZVendor\\Swoole\\WebSocket\\CloseFrame',
        'PPLCZVendor\\Swoole\\WebSocket\\Frame',
        'PPLCZVendor\\Swoole\\WebSocket\\Server',
