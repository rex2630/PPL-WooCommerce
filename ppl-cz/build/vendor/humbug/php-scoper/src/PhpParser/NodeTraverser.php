...
use PPLCZVendor\Humbug\PhpScoper\PhpParser\Node\NameFactory;
use PPLCZVendor\PhpParser\Node;
use PPLCZVendor\PhpParser\Node\Stmt;
use PPLCZVendor\PhpParser\Node\Stmt\Declare_;
use PPLCZVendor\PhpParser\Node\Stmt\GroupUse;
use PPLCZVendor\PhpParser\Node\Stmt\InlineHTML;
...
use PPLCZVendor\PhpParser\NodeVisitor;
