...
PHP
, 'Exposed namespaced function call imported with a partial use statement in the global scope' => ['expose-functions' => ['PPLCZVendor\\Foo\\main'], 'expected-recorded-functions' => [['PPLCZVendor\\Foo\\main', 'PPLCZVendor\\Humbug\\Foo\\main']], 'payload' => <<<'PHP'
<?php
