...
PHP
, 'FQ Constant call on an exposed namespaced class partially imported with an aliased use statement' => ['expose-classes' => ['PPLCZVendor\\Foo\\Bar'], 'expected-recorded-classes' => [['PPLCZVendor\\Foo\\Bar', 'PPLCZVendor\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ constant call on an exposed namespaced class imported with an aliased use statement' => ['expose-classes' => ['PPLCZVendor\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
