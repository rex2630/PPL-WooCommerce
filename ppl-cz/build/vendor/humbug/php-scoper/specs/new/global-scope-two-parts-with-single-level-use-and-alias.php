...
PHP
, 'New statement call of an exposed namespaced class partially imported with an aliased use statement' => ['expose-classes' => ['PPLCZVendor\\Foo\\Bar'], 'expected-recorded-classes' => [['PPLCZVendor\\Foo\\Bar', 'PPLCZVendor\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'New statement call of an exposed namespaced class imported with an aliased use statement' => ['expose-classes' => ['PPLCZVendor\\Foo\\Bar'], 'expected-recorded-classes' => [['PPLCZVendor\\Foo\\Bar', 'PPLCZVendor\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
