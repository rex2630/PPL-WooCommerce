...
PHP
, 'Static method call statement of an exposed class via a use statement' => ['expose-classes' => ['PPLCZVendor\\X\\Foo\\Bar'], 'expected-recorded-classes' => [['PPLCZVendor\\X\\Foo\\Bar', 'PPLCZVendor\\Humbug\\X\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ static method call statement of a non-exposed class via a use statement' => ['expose-classes' => ['PPLCZVendor\\X\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
