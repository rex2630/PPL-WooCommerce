...
class UpdateParcelModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PPLCZ\\Model\\Model\\UpdateParcelModel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'PPLCZ\\Model\\Model\\UpdateParcelModel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLCZ\Model\Model\UpdateParcelModel();
    ...
    {
        $data = array();
        if ($object->isInitialized('parcelCode') && null !== $object->getParcelCode()) {
    ...
    {
        return array('PPLCZ\\Model\\Model\\UpdateParcelModel' => false);
    }
}