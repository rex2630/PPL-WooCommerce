...
use PPLCZVendor\JetBrains\PhpStorm\ArrayShape;
use PPLCZVendor\JetBrains\PhpStorm\Deprecated;
use PPLCZVendor\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware;
use PPLCZVendor\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable;
use PPLCZVendor\JetBrains\PhpStorm\Pure;
/**
 ...
 */
function stream_select(?array &$read, ?array &$write, ?array &$except, ?int $seconds) : int|false
{
}
/**
 ...
 * @return bool true on success or false on failure.
 */
function stream_set_timeout($stream, int $seconds) : bool
{
}
/**
 * Alias:
 ...
 * @return bool true on success or false on failure.
 */
function socket_set_timeout($stream, int $seconds) : bool
{
}
/**
 * Alias:
