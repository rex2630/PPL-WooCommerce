...
trait ObjectCheckTrait
{
    ...
    {
        if (JsonSchema::class === ($objectClass = \get_class($object)) || 'Jane\\Component\\OpenApi2\\JsonSchema\\Model\\Schema' === $objectClass || 'Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Schema' === $objectClass) {
            return \true;
        }
        return \false;
    }
