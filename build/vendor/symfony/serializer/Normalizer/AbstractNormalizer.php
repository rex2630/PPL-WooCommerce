...
use PPLCZVendor\Symfony\Component\Serializer\Exception\CircularReferenceException;
...
use PPLCZVendor\Symfony\Component\Serializer\Exception\RuntimeException;
...
use PPLCZVendor\Symfony\Component\Serializer\SerializerAwareInterface;
use PPLCZVendor\Symfony\Component\Serializer\SerializerAwareTrait;
/**
        ...
        if ($constructor) {
            ...
            foreach ($constructorParameters as $constructorParameter) {
                ...
                if ($constructorParameter->isVariadic()) {
                    ...
                    $exception = NotNormalizableValueException::createForUnexpectedDataType(\sprintf('Failed to create object because the class misses the "%s" property.', $constructorParameter->name), null, [$constructorParameterType], $context['deserialization_path'], \true);
                    $context['not_normalizable_value_exceptions'][] = $exception;
                }
            }
