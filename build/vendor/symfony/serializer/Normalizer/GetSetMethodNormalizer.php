...
class GetSetMethodNormalizer extends AbstractObjectNormalizer
{
    ...
    {
        return parent::supportsNormalization($data, $format) && $this->supports(\get_class($data), \true);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return !$method->isStatic() && (\PHP_VERSION_ID < 80000 || !$method->getAttributes(Ignore::class)) && !$method->getNumberOfRequiredParameters() && (2 < ($methodLength = \strlen($method->name)) && \str_starts_with($method->name, 'is') || 3 < $methodLength && (\str_starts_with($method->name, 'has') || \str_starts_with($method->name, 'get')));
    }
    /**
    ...
    {
        return !$method->isStatic() && (\PHP_VERSION_ID < 80000 || !$method->getAttributes(Ignore::class)) && 0 < $method->getNumberOfParameters() && \str_starts_with($method->name, 'set');
    }
    /**
     * {@inheritdoc}
     */
