...
use PPLCZVendor\GuzzleHttp\Cookie\CookieJar;
use PPLCZVendor\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \PPLCZVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
