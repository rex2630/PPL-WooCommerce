...
namespace PPLCZVendor\Rs\Json;

use PPLCZVendor\Rs\Json\Pointer\InvalidJsonException;
use PPLCZVendor\Rs\Json\Pointer\InvalidPointerException;
use PPLCZVendor\Rs\Json\Pointer\NonexistentValueReferencedException;
use PPLCZVendor\Rs\Json\Pointer\NonWalkableJsonException;
class Pointer
{
    const POINTER_CHAR = '/';
