...
namespace PPLCZVendor\Http\Message\StreamFactory;

use PPLCZVendor\Http\Message\StreamFactory;
use PPLCZVendor\Laminas\Diactoros\Stream as LaminasStream;
use PPLCZVendor\Psr\Http\Message\StreamInterface;
use PPLCZVendor\Zend\Diactoros\Stream as ZendStream;
